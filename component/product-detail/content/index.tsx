...
const Content = ({ product }: productContent) => {
  ...
  return (
    <section className=" max-w-7xl m-auto text-gray-600 body-font overflow-hidden">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex mb-4">
              <span className="flex items-center">
                ...
                <span className="text-gray-600 ml-3">{product.punctuation.countOpinions} Reviews</span>
              </span>
            </div>
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex">
                ...
                {product?.colors?.map((color, index) => (
                  ...
                  key={index}
                  className={`border-2 border-gray-300 ml-1 rounded-full w-6 h-6 focus:outline-none ${selectedColor === color ? 'border-stone-800' : ''}`}
